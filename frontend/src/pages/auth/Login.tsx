...
import { login, verifyToken, getRegistrationStatus, getLoginInfoStatus, generateCaptcha, verifyCaptcha, sendVerificationCode, getLoginBrandingSettings, getAuthFooterAdSettings } from '@/api/auth'
